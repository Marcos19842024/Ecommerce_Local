...
export const MedicalPage = () => {
    return (
        <div className='relative bg-gray-900 text-white items-center'>
			...
			<div className='relative z-10 flex flex-col items-center justify-center py-2 px-4 text-center lg:py-2 lg:px-8'>
				<button
					className={`rounded-full bg-[#2980b9] uppercase font-semibold`}>
					<a
						href={socialLinks[2].href}
						target='_blank'
						rel='noreferrer'
						className='text-slate-200 py-3.5 flex items-center justify-center transition-all hover:text-black'>
						Reserva tu cita
					</a>
				</button>
			</div>
